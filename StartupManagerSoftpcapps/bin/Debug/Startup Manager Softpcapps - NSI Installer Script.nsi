...
;copy translations end
  ...
  !define MUI_FILE "StartupManagerSoftpcapps"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Startup Manager Softpcapps"
  !define PRODUCT_SHORTCUT "Startup Manager Softpcapps"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Startup Manager Softpcapps"
  OutFile "StartupManagerSoftpcappsSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Startup Manager Softpcapps" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Startup Manager Softpcapps - User's Manual.url.lnk" "$INSTDIR\Startup Manager Softpcapps - User's Manual.url" "" "$INSTDIR\Startup Manager Softpcapps - User's Manual.url" 0
...
;begin new uninstall strings
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Startup Manager Softpcapps" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Startup Manager Softpcapps" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Startup Manager Softpcapps"
  DeleteRegKey HKCU "Software\softpcapps Software\Startup Manager Softpcapps"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://softpcapps.com/startup-manager/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "https://softpcapps.com/startup-manager/how-to-use.php?afterinstall=true"
FunctionEnd
